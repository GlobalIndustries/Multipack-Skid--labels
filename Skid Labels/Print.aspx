<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Print.aspx.cs" Inherits="Skid_Labels.Print" %>
...
<table style="width: 100%;">
        ...
        <td colspan="5">
            <asp:GridView ID="gvPrinting" runat="server" AutoGenerateColumns="False" DataSourceID="sdsPrinting" OnRowDataBound="gvPrinting_Databound">
                <Columns>
                    ...
                    <asp:BoundField DataField="BulkCarton" HeaderText="Bulk Ctn" SortExpression="BulkCarton" />
    ...
    <tr>
        <td>
            <asp:LinkButton ID="lbPrintAll" Text="Print All Labels" runat="server" OnClick="btnPrintSelected_Click"></asp:LinkButton>&nbsp;&nbsp;
            <asp:LinkButton ID="lbPrintSelected" Text="Print Selected Labels" runat="server" OnClick="btnPrintSelected_Click"></asp:LinkButton>
        </td>
        <td>
